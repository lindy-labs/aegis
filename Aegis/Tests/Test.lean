...
info: Except.ok { typedefs := [(Sierra.Identifier.name "F" [] none, Sierra.Identifier.name "felt252" [] none)],
  ...
  statements := [{ label := none,
                   libfunc_id := Sierra.Identifier.name "c1" [] none,
                   args := [],
...
info: Except.ok { typedefs := [(Sierra.Identifier.ref 0, Sierra.Identifier.name "felt252" [] none),
  ...
  statements := [{ label := none,
                   libfunc_id := Sierra.Identifier.ref 2,
                   args := [],
                   branches := [{ target := none, results := [1] }] },
                 { label := none,
                 ...
                 { label := none,
                   libfunc_id := Sierra.Identifier.ref 0,
                   args := [2],
                   branches := [{ target := none, results := [] }, { target := some (Sum.inl 10), results := [4] }] },
                 { label := none,
                   libfunc_id := Sierra.Identifier.ref 4,
                   args := [],
                 ...
                 { label := none,
                   ...
                   args := [],
                   branches := [{ target := some (Sum.inl 13), results := [] }] },
                 { label := none,
                   libfunc_id := Sierra.Identifier.ref 4,
                   args := [],
                   branches := [{ target := none, results := [] }] },
  ...
  libfuncs := [(Sierra.Identifier.name "init" [] none,
               ...
               (Sierra.Identifier.name "ematch" [] none,
                Sierra.Identifier.name
                  ...
                  none)],
  statements := [{ label := none,
                   libfunc_id := Sierra.Identifier.name "init" [] none,
                   args := [0],
                   branches := [{ target := none, results := [1] }] },
                 { label := none,
                   libfunc_id := Sierra.Identifier.name "ematch" [] none,
                   args := [1],
                   branches := [{ target := none, results := [2] }, { target := some (Sum.inl 3), results := [3] }] },
                 { label := none, libfunc_id := Sierra.Identifier.name "return" [] none, args := [2], branches := [] },
...
info: Except.ok { typedefs := [(Sierra.Identifier.name "F" [] none, Sierra.Identifier.name "felt252" [] none),
  ...
  libfuncs := [(Sierra.Identifier.name "construct" [] none,
                Sierra.Identifier.name
                  ...
                  none)],
  statements := [{ label := none,
                   libfunc_id := Sierra.Identifier.name "construct" [] none,
                   args := [0, 1],
                   branches := [{ target := none, results := [2] }] },
                 { label := none, libfunc_id := Sierra.Identifier.name "return" [] none, args := [2], branches := [] }],
  declarations := [(Sierra.Identifier.name "foo" [] none,
  ...
  libfuncs := [(Sierra.Identifier.name "c5" [] none,
               ...
               (Sierra.Identifier.name "call" [] none,
                Sierra.Identifier.name
                  ...
                  none)],
  statements := [{ label := none,
                   libfunc_id := Sierra.Identifier.name "c5" [] none,
                   args := [],
                   branches := [{ target := none, results := [1] }] },
                 { label := none, libfunc_id := Sierra.Identifier.name "return" [] none, args := [1], branches := [] },
                 { label := none,
  ...
  libfuncs := [(Sierra.Identifier.name "a" [] none,
               ...
               (Sierra.Identifier.name "s" [] none,
                Sierra.Identifier.name
                  ...
                  none)],
  statements := [{ label := none,
                   libfunc_id := Sierra.Identifier.name "a" [] none,
                   args := [],
                   branches := [{ target := none, results := [1] }] },
                 { label := none,
